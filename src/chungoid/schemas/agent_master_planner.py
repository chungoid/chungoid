...
class MasterPlannerInput(BaseModel):
    ...
    blueprint_reviewer_feedback_doc_id: Optional[str] = Field(None, description="ChromaDB ID of blueprint review feedback (now generated by EnhancedArchitectAgent_v1).")
